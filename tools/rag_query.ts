...
import {DEFAULT_TOP_K, LOCATION, PROJECT_ID,} from '../config.js';
import {findBestMatchingCorpus, setCurrentCorpus} from './utils.js';
import {buildResponse} from './shared.js';

type IRetrieveContextsRequest = protos.google.cloud.aiplatform.v1.IRetrieveContextsRequest;
